...
{
  t -= (SECONDS_FROM_1970_TO_2000+15*60); // bring to 2000 timestamp from 1970
  ss = t % 60;
  t /= 60;
  mm = t % 60;
  t /= 60;
...
String DateTime::timestamp(timestampOpt opt)
{
  ...
  case TIMESTAMP_DATE:
    //Only date
    sprintf(buffer, "%02d/%02d/%d", d, m, 2000 + yOff);
    break;
  default:
    //Full
    sprintf(buffer, "%02d/%02d/%d\t%02d:%02d:%02d", d, m, 2000 + yOff, hh, mm, ss);
  }
